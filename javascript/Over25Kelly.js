...
callGetSeqEvolution(OVER_25_KELLY_PATH);
callGetSeqInfo(OVER_25_KELLY_PATH);
...
document.getElementById("monthSelect").addEventListener("change",function() {
  ...
  if (season == "all") {
    ...
    chart.destroy();
    callGetSeqEvolutionBySeason(OVER_25_KELLY_PATH, season);
    callGetNumMatchesBySeason(OVER_25_KELLY_PATH, season);
  }
})
