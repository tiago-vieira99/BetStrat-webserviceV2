...
function addDataToTable(statsData) {
    $(document).ready(function() {
      $('#goalsFestDataByTeamTable').append(
        ...
        '<td style="padding-top: 0; padding-bottom: 0;" class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell">' + statsData.noGoalsFestSequence + '</td></tr>'
      );
    });
}
