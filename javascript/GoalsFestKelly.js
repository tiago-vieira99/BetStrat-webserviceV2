...
callGetSeqEvolution(GOALS_FEST_KELLY_PATH);
callGetSeqInfo(GOALS_FEST_KELLY_PATH);
...
document.getElementById("monthSelect").addEventListener("change",function() {
  ...
  if (season == "all") {
    ...
    chart.destroy();
    callGetSeqEvolutionBySeason(GOALS_FEST_KELLY_PATH, season);
    callGetNumMatchesBySeason(GOALS_FEST_KELLY_PATH, season);
  }
})
