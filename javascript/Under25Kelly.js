...
callGetSeqEvolution(UNDER_25_KELLY_PATH);
callGetSeqInfo(UNDER_25_KELLY_PATH);
...
document.getElementById("monthSelect").addEventListener("change",function() {
  ...
  if (season == "all") {
    ...
    chart.destroy();
    callGetSeqEvolutionBySeason(UNDER_25_KELLY_PATH, season);
    callGetNumMatchesBySeason(UNDER_25_KELLY_PATH, season);
  }
})
